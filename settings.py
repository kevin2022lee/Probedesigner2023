"""
Django settings for OligoDesigner project.
...
ROOT_URLCONF = 'OligoDesigner.urls'
...
HELP_ROOT=os.path.join( BASE_DIR , 'help').replace('\\','/')
STATICFILES_DIRS = (
       os.path.join(BASE_DIR,'help').replace('\\','/'),
)
